...
namespace AutofacComnityToolKitGetProc
{
    public partial class MyToolWindowViewModel : ObservableObject
    {
        ...
        public MyToolWindowViewModel()
        {
            ...
            AutofacComnityToolKitGetProcPackage.OnEnterRunMode += DebuggerEventsInstance_OnEnterRunMode;
            AutofacComnityToolKitGetProcPackage.OnEnterDesignMode += DebuggerEventsInstance_OnEnterDesignMode;
            AutofacComnityToolKitGetProcPackage.OnEnterBreakMode += DebuggerEventsInstance_OnEnterBreakMode;
            AutofacComnityToolKitGetProcPackage.OnContextChanged += DebuggerEventsInstance_OnContextChanged;
            AutofacComnityToolKitGetProcPackage.OnExceptionThrown += DebuggerEventsInstance_OnExceptionThrown;
            AutofacComnityToolKitGetProcPackage.OnExceptionNotHandled += DebuggerEventsInstance_OnExceptionNotHandled;
