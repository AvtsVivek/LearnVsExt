...
namespace FilePathToContentTypeProviderIntro
{
    ...
    internal sealed class TestCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("89f53977-56e7-47e7-8099-864f66ca87cc");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var filePathToContentTypeProvider = componentModel.GetService<IFilePathToContentTypeProvider>();
            

            string message = string.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()", this.GetType().FullName);
            string title = "TestCommand";

            if (filePathToContentTypeProvider == null)
            {
                message = $"{filePathToContentTypeProvider} is null ";
            }
