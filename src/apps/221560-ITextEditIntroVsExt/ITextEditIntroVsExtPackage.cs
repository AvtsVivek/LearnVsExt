...
namespace ITextEditIntroVsExt
{
    ...
    {
        /// <summary>
        /// ITextEditIntroVsExtPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "64b30190-e035-4ef0-a898-0771a650b162";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await TextEditToolWindowCommand.InitializeAsync(this);
        }
