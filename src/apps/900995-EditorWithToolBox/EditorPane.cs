...
namespace EditorWithToolBox
{
    ...
    /// tbx.tbx|{6d688609-4f87-4b6c-9ea5-7ca739dae8de}|#106|80|#109|{6d688609-4f87-4b6c-9ea5-7ca739dae8de}|401|0|#107
    ///
    /// The fields in order are as follows:-
    ///    - tbx.tbx - our empty tbx file
    ///    - {6d688609-4f87-4b6c-9ea5-7ca739dae8de} - our Editor package guid
    ...
    ///    - {6d688609-4f87-4b6c-9ea5-7ca739dae8de} - resource dll string (we don't use this)
...

    {
        ...
        protected override void Initialize()
        {
            ...
            if (toolboxData == null)
            {
                ...
                // IVsToolbox7 toolbox = (IVsToolbox7)GetService(typeof(SVsToolbox));
        ...
        private void NotifyDocChanged()
        {
            ...
            // IVsRunningDocumentTable runningDocTable = (IVsRunningDocumentTable)componentModel.GetService<SVsRunningDocumentTable>();


            if (runningDocTable == null)
            {
                MessageBox.Show(
                text: "SVsRunningDocumentTable instance is null.",
                caption: "IVsRunningDocumentTable instance is null.");
                return;
            }
