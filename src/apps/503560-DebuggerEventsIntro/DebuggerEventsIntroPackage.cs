...
namespace DebuggerEventsIntro
{
    ...
    public sealed class DebuggerEventsIntroPackage : AsyncPackage
    {
        ...
        public DebuggerEvents DebuggerEventsInstance
        { 
            [DispId(302)] 
            get;
            set;
        ...
        {
            MessageBox.Show("On Enter Break Mode ");
        }
        ...
        {
            MessageBox.Show("On Enter Run Mode");
        }
        ...
        {
            MessageBox.Show("On Exception Not Handled");
        }
        ...
        {
            MessageBox.Show("On Exception Thrown");
        }
        ...
        {
            MessageBox.Show("On Context Changed");
        }
