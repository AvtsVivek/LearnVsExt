...
namespace TrackingSpanIntro
{
    ...
    /// </summary>
    public partial class TrackingSpanTestControl : UserControl
    {
        ...
        private ITrackingSpan _trackingSpan = null;
        ...
        /// </summary>
        public TrackingSpanTestControl()
        {
            ...
            // DataContext = this;
            spanTrackingModeComboBox.ItemsSource = SpanTrackingModeArray;
        }

        public Array SpanTrackingModeArray
        {
            get
            {
                return Enum.GetValues(typeof(SpanTrackingMode));
            }
        }
        ...
        private void createTrackingSpan_Click(object sender, RoutedEventArgs e)
        {
            if (IsTextBufferNull())
            {
                return;
            ...
            if (string.IsNullOrWhiteSpace(spanLength))
            {
                MessageBox.Show(
                messageBoxText: "Span Length is null or empty string. Cannot continue",
            ...
            if (!Enum.TryParse(spanTrackingModeComboBox.SelectedItem.ToString(), false, out SpanTrackingMode spanTrackingMode))
            {
                MessageBox.Show(
            ...
            {
                MessageBox.Show(
                messageBoxText: "Custom span tracking mode is not supported.",
                caption: "custom span tracking mode not supported.");
                return;
            }
