...
namespace WebSearchMultipleOptions
{
    ...
    {
        /// <summary>
        /// WebSearchMultipleOptionsPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "96454401-ca43-4ef8-85eb-6d6b494c0a33";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await Commands.WebSearchCommand.InitializeAsync(this);
        }
