...
namespace TextSnapshotIntro
{
    ...
    {
        /// <summary>
        /// TextSnapshotIntroPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "407c5a69-dad5-4db7-8939-f775f27dbcab";
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await ToolWindowForTextSnapshotCommand.InitializeAsync(this);
        }
