...
cd src/tasks/800420-SpellingErrorList

cd src/apps/800420-SpellingErrorList

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./SpellingErrorList.csproj
