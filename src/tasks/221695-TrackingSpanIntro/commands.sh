...
cd src/tasks/221695-TrackingSpanIntro

cd src/apps/221695-TrackingSpanIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TrackingSpanIntro.csproj
