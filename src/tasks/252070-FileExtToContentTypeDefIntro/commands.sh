...
cd src/tasks/252070-FileExtToContentTypeDefIntro

cd src/apps/252070-FileExtToContentTypeDefIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./FileExtToContentTypeDefIntro.csproj
...
nuget restore ./FileExtToContentTypeDefIntro.sln

devenv /build Debug ./FileExtToContentTypeDefIntro.sln

devenv /Rebuild Debug ./FileExtToContentTypeDefIntro.sln
...
./FileExtToContentTypeDefIntro.vsix
