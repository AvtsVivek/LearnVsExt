...
cd src/tasks/217725-ImageManifestToolsExten

cd src/apps/217725-ImageManifestToolsExten

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./ImageManifestToolsExten.csproj
...
devenv /build Debug ./ImageManifestToolsExten.sln
