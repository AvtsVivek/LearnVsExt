...
cd src/tasks/900900-LinqLanguageEditor

cd src/apps/900900-LinqLanguageEditor

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./LinqLanguageEditor.csproj
