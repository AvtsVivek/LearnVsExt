...
cd src/tasks/236000-HelloWorldCompletion

cd src/apps/236000-HelloWorldCompletion

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./HelloWorldCompletion.csproj
...
nuget restore ./HelloWorldCompletion.sln

devenv /build Debug ./HelloWorldCompletion.sln

devenv /Rebuild Debug ./HelloWorldCompletion.sln
