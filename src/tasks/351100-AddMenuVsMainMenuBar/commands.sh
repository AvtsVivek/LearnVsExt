...
cd src/tasks/351100-AddMenuVsMainMenuBar

cd src/apps/351100-AddMenuVsMainMenuBar

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./AddMenuVsMainMenuBar.csproj
