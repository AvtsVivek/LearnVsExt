...
cd src/tasks/900960-ProjectionBufferTut

cd src/apps/900960-ProjectionBufferTut

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./ProjectionBufferTut.csproj
