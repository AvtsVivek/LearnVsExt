...
cd src/tasks/503560-DebuggerEventsIntro

cd src/apps/503560-DebuggerEventsIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./DebuggerEventsIntro.csproj
