...
cd src/tasks/224550-WpfTextViewHostControl

cd src/apps/224550-WpfTextViewHostControl

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./WpfTextViewHostControl.csproj
