...
cd src/tasks/502500-SimpleToolWindow

cd src/apps/502500-SimpleToolWindow

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./SimpleToolWindow.csproj
