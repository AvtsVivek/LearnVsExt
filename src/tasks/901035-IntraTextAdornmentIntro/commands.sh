...
cd src/tasks/901035-IntraTextAdornmentIntro

cd src/apps/901035-IntraTextAdornmentIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./IntraTextAdornmentIntro.csproj
...
devenv /build Debug ./IntraTextAdornmentIntro.sln

# If you just want to start and run visual studi in experimental mode, run the following command.
devenv.exe /RootSuffix Exp ./IntraTextAdornmentIntro.sln
