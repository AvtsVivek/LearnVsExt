...
cd src/tasks/901010-ToolboxTrailOne

cd src/apps/901010-ToolboxTrailOne

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./ToolboxTrailOne.csproj
