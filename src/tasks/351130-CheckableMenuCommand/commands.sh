...
cd src/tasks/351130-CheckableMenuCommand

cd src/apps/351130-CheckableMenuCommand

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./CheckableMenuCommand.csproj
