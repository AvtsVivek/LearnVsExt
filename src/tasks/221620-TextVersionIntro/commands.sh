...
cd src/tasks/221620-TextVersionIntro

cd src/apps/221620-TextVersionIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TextVersionIntro.csproj
