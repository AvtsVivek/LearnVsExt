...
cd src/tasks/501170-OleMenuCommandIntro

cd src/apps/501170-OleMenuCommandIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./OleMenuCommandIntro.csproj
