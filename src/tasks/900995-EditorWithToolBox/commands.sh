...
cd src/tasks/900995-EditorWithToolBox

cd src/apps/900995-EditorWithToolBox

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./EditorWithToolBox.csproj
