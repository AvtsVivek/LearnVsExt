...
cd src/tasks/503500-SolutionEventsIntro

cd src/apps/503500-SolutionEventsIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./SolutionEventsIntro.csproj
