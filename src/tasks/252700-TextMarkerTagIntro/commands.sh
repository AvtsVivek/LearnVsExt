...
cd src/tasks/252700-TextMarkerTagIntro

cd src/apps/252700-TextMarkerTagIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TextMarkerTagIntro.csproj
