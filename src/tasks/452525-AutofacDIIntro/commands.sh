...
cd src/tasks/452525-AutofacDIIntro

cd src/apps/452525-AutofacDIIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./AutofacDIIntro.csproj
