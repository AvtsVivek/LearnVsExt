...
cd src/tasks/800900-TypingSpeedMeter

cd src/apps/800900-TypingSpeedMeter

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TypingSpeedMeter.csproj
