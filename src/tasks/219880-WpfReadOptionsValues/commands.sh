...
cd src/tasks/219880-WpfReadOptionsValues

cd src/apps/219880-WpfReadOptionsValues

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./WpfReadOptionsValues.csproj
