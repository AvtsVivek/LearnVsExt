...
cd src/tasks/901040-SmartTagExOne

cd src/apps/901040-SmartTagExOne

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./SmartTagExOne.csproj
