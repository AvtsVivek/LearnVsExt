...
cd src/tasks/800920-KeyBindingTest

cd src/apps/800920-KeyBindingTest

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./KeyBindingTest.csproj
