...
cd src/tasks/800410-DiffClassifier

cd src/apps/800410-DiffClassifier

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./DiffClassifier.csproj
