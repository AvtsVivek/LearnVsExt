...
cd src/tasks/401105-WpfAppToExtractVsMonikers

cd src/apps/401105-WpfAppToExtractVsMonikers

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./WpfAppToExtractVsMonikers.csproj
...
nuget restore ./WpfAppToExtractVsMonikers.sln

devenv /build Debug ./WpfAppToExtractVsMonikers.sln

devenv /Rebuild Debug ./WpfAppToExtractVsMonikers.sln
...
./WpfAppToExtractVsMonikers.vsix
