...
cd src/tasks/252580-TagAggregatorIntro

cd src/apps/252580-TagAggregatorIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TagAggregatorIntro.csproj
