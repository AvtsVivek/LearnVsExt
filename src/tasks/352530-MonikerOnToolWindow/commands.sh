...
cd src/tasks/352530-MonikerOnToolWindow

cd src/apps/352530-MonikerOnToolWindow

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./MonikerOnToolWindow.csproj
