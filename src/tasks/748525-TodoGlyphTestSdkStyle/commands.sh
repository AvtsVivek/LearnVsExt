...
cd src/tasks/748525-TodoGlyphTestSdkStyle

cd src/apps/748525-TodoGlyphTestSdkStyle

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TodoGlyphTestSdkStyle.csproj
