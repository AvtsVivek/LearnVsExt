...
cd src/tasks/901020-XmlEditorFeatures

cd src/apps/901020-XmlEditorFeatures

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./XmlEditorFeatures.csproj
