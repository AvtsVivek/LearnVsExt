...
cd src/tasks/748510-TodoGlyphTest

cd src/apps/748510-TodoGlyphTest

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TodoGlyphTest.csproj
