...
cd src/tasks/221675-TrackingPointIntro

cd src/apps/221675-TrackingPointIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TrackingPointIntro.csproj
