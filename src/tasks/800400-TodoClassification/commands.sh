...
cd src/tasks/800400-TodoClassification

cd src/apps/800400-TodoClassification

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./TodoClassification.csproj
