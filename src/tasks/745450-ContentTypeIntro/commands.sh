...
cd src/tasks/745450-ContentTypeIntro

cd src/apps/745450-ContentTypeIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./ContentTypeIntro.csproj
