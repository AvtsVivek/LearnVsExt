...
cd src/tasks/748500-ContentTypeFileExt

cd src/apps/748500-ContentTypeFileExt

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./ContentTypeFileExt.csproj
