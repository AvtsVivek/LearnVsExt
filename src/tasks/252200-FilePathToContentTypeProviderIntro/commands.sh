...
cd src/tasks/252200-FilePathToContentTypeProviderIntro

cd src/apps/252200-FilePathToContentTypeProviderIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./FilePathToContentTypeProviderIntro.csproj
...
./FilePathToContentTypeProviderIntro.vsix
