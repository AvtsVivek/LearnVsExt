...
cd src/tasks/503530-BuildEventsIntro

cd src/apps/503530-BuildEventsIntro

## I dont think we can build using the following dotnet command. 
## The project is not a dotnet core project. 

dotnet build --project ./BuildEventsIntro.csproj
