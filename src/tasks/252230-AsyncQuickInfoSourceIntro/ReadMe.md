...
## Build and Run
1. Reset Vs Exp instance, Rebuild, and launch the app.
...
4. So this `LineAsyncQuickInfoSource` is applicable to only those files whose content type is specified as attribute above.
...
7.  Now open a text file. Each time a text file is opened and the mouse is hovered over the text, the break point is hit.
